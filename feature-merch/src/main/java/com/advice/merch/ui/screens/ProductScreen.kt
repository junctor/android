...
import com.advice.merch.ui.components.LabelButton
import com.advice.merch.ui.components.LegalLabel
import com.advice.merch.ui.components.LowStockLabel
import com.advice.merch.ui.components.OutOfStockLabel
import com.advice.merch.ui.components.PriceLabel
import com.advice.merch.ui.components.QuantityAdjuster
import com.advice.merch.ui.components.VariantsBottomSheet
        ...
        Column {
            ...
            if (product.requiresSelection) {
                ...
                ProductRow(
                    ...
                    val label =
                        selection?.label
                            ?: stringResource(com.advice.merch.R.string.select_variant)
...
private fun FooterButton(
    ...
    val label =
        if (enabled) {
            stringResource(com.advice.merch.R.string.add_to_cart)
        } else {
            stringResource(com.advice.merch.R.string.add_to_cart_disabled)
        }
