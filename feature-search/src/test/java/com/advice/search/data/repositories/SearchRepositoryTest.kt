package com.advice.search.data.repositories
...
class SearchRepositoryTest {
    ...
    private val eventsDataSource = mockk<ContentDataSource>()
    ...
    private val tagsDataSource = mockk<TagsDataSource>()
    ...
    private fun getSubject(): SearchRepository {
        ...
        every { eventsDataSource.get() } returns
        ...
        every { tagsDataSource.get() } returns
